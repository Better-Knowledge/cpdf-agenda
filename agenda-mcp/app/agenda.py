...
`Authorization` que o chamador apresentou — aqui, tipicamente o `ats_…` que o
canal cunhou depois de provar o endereço do cliente (RF-19). Não é economia de configuração: no
...
log = logging.getLogger("agenda_mcp.agenda")
...
async def chamar(
    ...
    *,
    ...
    cabecalhos = {
        ...
        # faz a linha do log dizer "agenda_agendar" em vez de "POST
        # /appointments" — a pergunta "o que o agente fez" respondida no
