...
# A credencial típica deste conector: sessão de atendimento, com titular e
# **sem** agenda:cancel. É o que faz "cancelar" virar encaminhamento humano.
IDENTIDADE = {
...
BEARER = "Bearer ats_token-de-sessao-de-teste"
